...
class Category(models.Model):
    user=models.ForeignKey(settings.AUTH_USER_MODEL,editable=False,on_delete=models.CASCADE,null=False,related_name='blog_user')
...
class Blog(models.Model):
    ...
    description = RichTextField()
    photo= models.ImageField(upload_to ='blog_images/',default='blogs.png')
